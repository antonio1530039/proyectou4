...
<html lang="en">
   <head>
      ...
      <?php
        $date = date('Y-m-d');
        echo "<title>SuBodega - Corte de caja - Fecha ".$date."</title>";
       ?>
            ...
            <div id="page-right-content">
               <div class="container">
                  ...
                  <p class="text-muted font-13 m-b-30">
                      De clic en los botones de abajo para exportar o guardar el corte de caja. Tambien puede filtrar ingresando el criterio de busqueda en el campo Search.
                  </p>
                 <div class="row p-t-50">
                  <center><h3><?php $date= date("Y-m-d"); echo "Fecha de corte: ".$date; ?></h3></center><br>
                           <div class="col-sm-12">
                                   ...
                                   <table id="datatable-buttons" class="table table-striped table-bordered">
                                       ...
                                       <tbody>
                                         ...
                                         if ($conn->connect_error) {
                                            ...
                                            $date = date('Y-m-d');
                                             $sql = "SELECT * FROM venta WHERE deleted=0 and fecha='".$date."'";
                                                 $result = $conn->query($sql);
                                                 if($result->num_rows>0){
                                                   while($row = $result->fetch_assoc()){
                                                     echo "<tr>";
                                                     echo "<td>".$row["id"]."-".$row["clave"]."</td>";
